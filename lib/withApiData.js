        ...
        var WithApiData = /** @class */ (function (_super) {
            ...
            WithApiData.prototype.render = function () {
                ...
                var checkLoading = function (binding, instanceId) {
                    var _a;
                    if (instanceId === void 0) { instanceId = ''; }
                    var config = __assign(__assign(__assign({}, _this.props.apiData.globalConfig), _this.props.apiData.endpointConfig[binding.request.endpointKey]), ((_a = configs === null || configs === void 0 ? void 0 : configs[binding.request.endpointKey]) !== null && _a !== void 0 ? _a : {}));
